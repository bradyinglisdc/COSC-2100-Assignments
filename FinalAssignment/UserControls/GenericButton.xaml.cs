...
namespace FinalAssignment
{
    ...
    public partial class GenericButton : Border 
    {
        ...
        /// <summary>
        /// Gets and sets the font size of the text block
        /// </summary>
        public double FontSize
        {
            get { return tboContent.FontSize; }
            set { tboContent.FontSize = value; }
        }

        /// <summary>
        /// Gets and sets the font weight of the text block
        /// </summary>
        public FontWeight FontWeight
        {
            get { return tboContent.FontWeight; }
            set { tboContent.FontWeight = value; }
        }
